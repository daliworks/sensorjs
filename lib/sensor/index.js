...
var addSensorPackage = function (sensor) {
  ...
  logger.info('[sensor/index.js] _cachedNetworks', _cachedNetworks);
  logger.info('[sensor/index.js] _cachedDrivers', _cachedDrivers);
  logger.info('[sensor/index.js] added sensor', sensor);
  logger.info('[sensor/index.js] updated DRIVER_CFG', DRIVER_CFG);
};
...
var getUrl = function(sensorInfo) {
  return ['sensorjs://', sensorInfo.device.sensorNetwork, sensorInfo.device.address, sensorInfo.model, sensorInfo.id].join('/');
};
