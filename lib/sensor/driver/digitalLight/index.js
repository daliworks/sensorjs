    ...
    switch (this.model) {
      ...
      case 'BH1750':
        ...
        this.wire.on('sensorSettingChanged', function (e) {
          logger.debug('[DigitalLight] sensorSettingChanged', e);
        });
        this.wire.on('sensorSettingFailed', function (e) {
          logger.debug('[DigitalLight] sensorSettingFailed', e);
        });
        this.wire.on('newSensorValue', function (e) {
          logger.debug('[DigitalLight] newSensorValue', e);
        });
        this.wire.on('sensorValueError', function (e) {
          logger.debug('[DigitalLight] sensorValueError', e);
        });
